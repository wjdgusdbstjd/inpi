...
var mySwiper = new Swiper("#swiper-container2", {
  ...
  on: {
    ...
    transitionStart: function () {
      ...
      const containerTop = (windowHeight - currentSlideHeight) / 2000;
      $(".swiper-wrapper").css(
        "transform",
...
observer8.observe(document.querySelector(".interview-title")); //텍스트 컨테이너 요소의 감시를 시작한다.
...
observer9.observe(document.querySelector(".pretendard"));
...
observer10.observe(document.querySelector(".pretendard"));
